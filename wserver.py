    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/andresde141">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://t.me/Bangladeshhoarding"><i class="fab fa-github"></i></a>
        <a href="https://t.me/andresde141"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
<body>
   <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://t.me/bangladeshhoarding"><i class="fab fa-github"></i></a>
        <a href="https://t.me/andrede141"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
async def homepage(request):
    ...
    return web.Response(text="<h1>Bangladesh Hoarding <a href='https://t.me/andresde141'>@Telegram</a> By <a href='https://t.me/andresde141'>Berlin</a></h1>", content_type="text/html")
    ...
    async def middleware_handler(request):
        ...
        try:
            ...
            if response.status == 404:
                return web.Response(text="<h1>404: Page not found</h2><br><h3>BDH-aka-bangladeshhoarding</h3>", content_type="text/html")
            return response
