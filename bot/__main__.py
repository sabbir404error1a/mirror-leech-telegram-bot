...
def stats(update, context):
    ...
    f'├─<b>Bot Uptime:</b> {currentTime}\n'\
            ...
            f'├─⚠️<b>SWAP:</b> {swap_t} | <b>Used:</b> {swap_p}%\n'\
...
'''
        ...
        sendMarkup('𝐍𝐨𝐭 𝐀𝐮𝐭𝐡𝐨𝐫𝐢𝐳𝐞𝐝 𝐔𝐬𝐞𝐫. 𝐂𝐨𝐧𝐭𝐚𝐜𝐭 𝐁𝐨𝐭 𝐎𝐰𝐧𝐞𝐫 <b>@andresde141</b>', context.bot, update, reply_markup)
